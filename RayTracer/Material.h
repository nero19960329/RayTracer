...
public:
	explicit Material(real_t _ambient = DEFAULT_AMBIENT, real_t _specular = DEFAULT_SPECULAR, real_t _shininess = DEFAULT_SHININESS, real_t _refl = 0.0, real_t _refr = 0.0, const Vec3 &_emission = Vec3::BLACK) :
